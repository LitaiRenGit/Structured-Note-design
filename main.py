...
if __name__=='__main__':
    ...
    """
    res1=SN.option_payoff_fplot_with_dist(SN.vanilla_call,300,450,option_kwargs)
    res2=SN.structure_note_payoff_fplot_with_dist(SN.vanilla_call,300,450,structure_note_kwargs)
    """
